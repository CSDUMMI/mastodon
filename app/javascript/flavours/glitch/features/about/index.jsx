      ...
      <Column bindToDocument={!multiColumn} label={intl.formatMessage(messages.title)}>
        <div className='scrollable about'>
          ...
          <div className='about__footer'>
            <p><FormattedMessage id='about.fork_disclaimer' defaultMessage='Mastodon +Babka is free open source software forked from glitch-soc, which is in turn forked from Mastodon.' /></p>
