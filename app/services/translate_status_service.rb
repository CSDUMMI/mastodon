...
class TranslateStatusService < BaseService
  ...
  def permitted?
    ...
    return true if source_language == 'auto' || source_language == nil
  ...
  def source_language
    ...
    return 'auto' if ENV['AUTO_DETECT_LANGUAGE'] == 'true' && translation_backend.is_libre_translate?
    return nil if ENV['AUTO_DETECT_LANGUAGE'] == 'true' && translation_backend.is_deepl?
